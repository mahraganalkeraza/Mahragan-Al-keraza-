...
export default function AdminDisplayGate({ onClose, isInline = false }: { onClose?: () => void; isInline?: boolean }) {
  ...
  const qrValue = typeof window !== 'undefined' 
    ? `${window.location.origin}/exam-portal-route?gateway_token=${hourlyToken}` 
    : `https://mahraganalkeraza.github.io/Mahragan-Al-keraza-/#/exam-portal-route?gateway_token=${hourlyToken}`;
