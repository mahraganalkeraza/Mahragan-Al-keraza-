      ...
      <div className="hidden">
        ...
        >
          ...
          <div className="border-b-4 border-emerald-600 pb-6 mb-8 flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-black text-emerald-900 mb-1"> المنطقة 18 - مهرجان الكرازة المرقسية</h1>
          ...
          <div className="grid grid-cols-3 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200 mb-8 text-center">
            <div>
              ...
              <p className="text-base font-black text-slate-900 mt-1">{churchName || 'غير محدد'}</p>
            </div>
            <div>
              <p className="text-xs text-slate-500 font-bold">إجمالي عدد الطلاب الصاعدين</p>
              <p className="text-base font-black text-blue-700 mt-1">{totalQualifiedCount} طالب</p>
            </div>
            <div>
              <p className="text-xs text-slate-500 font-bold">إجمالي المطالبة المالية</p>
              <p className="text-base font-black text-emerald-700 mt-1">{totalAmountRequired.toLocaleString('ar-EG')} ج.م</p>
            </div>
          </div>
          ...
          <table className="w-full text-right border-collapse mb-8 text-xs">
            <thead>
              <tr className="bg-slate-100 text-slate-800 font-black">
                ...
                <th className="p-3 border border-slate-300 text-center"> المبلغ المستحق</th>
              </tr>
            </thead>
            <tbody>
            ...
            <tfoot>
              <tr className="bg-slate-100 font-black text-slate-900">
                <td colSpan={2} className="p-3 border border-slate-300 text-right">الإجمالي العام المستحق</td>
                <td className="p-3 border border-slate-300 text-center text-blue-900">{totalQualifiedCount} طالب</td>
                <td className="p-3 border border-slate-300 text-center">-</td>
                <td className="p-3 border border-slate-300 text-center text-emerald-900 text-sm">{totalAmountRequired.toLocaleString('ar-EG')} ج.م</td>
              </tr>
            </tfoot>
          </table>
          ...
          <div className="p-4 bg-emerald-50 border-2 border-emerald-600 rounded-xl text-center mb-10">
            <p className="text-xs font-bold text-emerald-800">المبلغ المطلوب</p>
