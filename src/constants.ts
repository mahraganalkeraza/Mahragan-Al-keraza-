...
export const DEFAULT_STAGES_CONFIG = [
  { id: 1, name: "حضانة", comps: ["دراسي", "محفوظات", "قبطي مستوى أول"], stage_type: "مهرجان" },
  { id: 2, name: "أولى وثانية", comps: ["دراسي", "محفوظات", "قبطي مستوى أول"], stage_type: "مهرجان" },
  { id: 3, name: "ثالثة ورابعة", comps: ["محفوظات", "دراسي", "قبطي مستوى أول", "قبطي مستوى ثان"], stage_type: "مهرجان" },
  { id: 4, name: "خامسة وسادسة", comps: ["دراسي", "محفوظات", "قبطي مستوى أول", "قبطي مستوى ثان"], stage_type: "مهرجان" },
  { id: 18, name: "إعدادي", comps: ["دراسي", "محفوظات", "قبطي مستوى أول", "قبطي مستوى ثان"], stage_type: "مهرجان" },
  { id: 19, name: "ثانوي", comps: ["دراسي", "محفوظات", "قبطي مستوى أول", "قبطي مستوى ثان"], stage_type: "مهرجان" },
  { id: 7, name: "جامعة", comps: ["دراسي", "قبطي مستوى أول", "قبطي مستوى ثان"], stage_type: "مهرجان" },
  { id: 8, name: "خريجون", comps: ["قبطي مستوى أول", "قبطي مستوى ثان", "دراسي"], stage_type: "مهرجان" },
  { id: 9, name: "خدام وإعداد الخدام", comps: ["دراسي", "قبطي مستوى أول"], stage_type: "مهرجان" },
  { id: 10, name: "قانا الجليل", comps: ["دراسي", "قبطي مستوى أول"], stage_type: "مهرجان" },
  { id: 11, name: "تعليم كبار", comps: ["دراسي", "قبطي مستوى أول"], stage_type: "مهرجان" },
  { id: 12, name: "سمعان الشيخ", comps: ["دراسي"], stage_type: "مهرجان" },
  { id: 13, name: "حرفيون", comps: ["دراسي"], stage_type: "مهرجان" },
  { id: 14, name: "صم وبكم", comps: ["دراسي"], stage_type: "مهرجان" },
  { id: 15, name: "قدرات خاصة", comps: ["دراسي"], stage_type: "مهرجان" },
  { id: 16, name: "ديديموس", comps: ["دراسي"], stage_type: "مهرجان" },
  { id: 17, name: "بولس وسيلا", comps: ["دراسي"], stage_type: "مهرجان" }
];
